...
import { FilterType } from "../Store/slices/filterSlice";
...
export function SiderbarItem({text, icon, filterType}: SiderbarItemProps){
    ...
    const handleClick = () => {
     ...
     return <div 
        ...
        w-48 pl-3 hover:text-purple-600 transition-all duration-300 ${
            isActive ? 'bg-purple-100 text-purple-600 border-r-2 border-purple-600' : ''
        }`}
        onClick={handleClick}
    >
            <div className="p-2">
