...
export function Dashboard() {
    ...
    //                         {activeFilter === 'all' ? 'All Content' : `${activeFilter.charAt(0).toUpperCase() + activeFilter.slice(1)} Content`}
    //                     </h2>
    ...
    //                     <div>
    //                         <Button variant="primary" styleType="primarystyle" text="Add Content" startIcon={<PlusIcon />} onClick={() => SetmodelOpen(true)} />
    //                     </div>
    //                     <div>
    ...
    //                             <Card type={type} link={link} title={title} id={_id} onDelete={() => handleDelete(_id)} />
    //                         </div>
    //                     ))
    //                 ) : (
    //                     <div className="w-full text-center text-gray-500 mt-8">
    ...
    <div className="flex-1 min-h-screen bg-gray-100 pl-64">
      ...
      {/* Cards */}
      <div className="flex mt-2 gap-9 flex-row p-4 flex-wrap">
        {loading ? (
          <div className="w-full text-center text-gray-500 mt-8">
            <p>Loading content...</p>
          </div>
